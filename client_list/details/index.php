                                            ...
                                            <div class="col-md-4 mb-4"> <!-- Make the cards responsive and inline -->
                                                <div class="card" style="width: 30rem;">
                                                    ...
                                                    <div class="card-footer" style="background-color: transparent; padding: 15px 15px;">
                                                        ...
                                                        <a href="<?php echo BASE_URL; ?>/engagements/?engagement_id=<?php echo $off_id; ?>" class="card-link float-end text-decoration-none" style="cursor: pointer;">Open Engagement  <i class="bi bi-chevron-right"></i></a>
                                                    </div>
                                                </div>
                                            </div>
