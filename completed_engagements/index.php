...
<head>
    ...
    <title>Completed Engagements - ARC Platform</title>
</head>
<body>
    ...
    <div class="container" style="background-color: #f2f2f2 !important;">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM engagement WHERE status = 'Completed' ORDER BY engagement_created ASC LIMIT $limit OFFSET $offset";
        ...
        $sql = "SELECT COUNT(*) as total FROM engagement WHERE status = 'Completed'";
        $result = mysqli_query($conn, $sql);
        if ($result) {
